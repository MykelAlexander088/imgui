...
//   (*) This is the suggested solution: pass indices to API (easy to iterate/interpolate) + persist your custom identifiers inside selection data.
...
// When your application settles on a choice, you may want to get rid of this indirection layer and do your on thing.
